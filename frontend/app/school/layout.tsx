...
export default function SchoolLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        if (!loading && user && user.role !== "SCHOOL_VIEWER") {
    ...
    if (!user || user.role !== "SCHOOL_VIEWER") return null;

    const links = [
        { href: "/school/report", label: "School Report", icon: BarChart3 },
    ];
            ...
            <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-slate-200 flex flex-col z-50">
                ...
                <div className="p-6 border-b border-slate-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-bold text-slate-800">School Viewer</h2>
                            <p className="text-xs text-slate-400">Assessment Reports</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-slate-200">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-slate-400 truncate">School Viewer</p>
                        </div>
                    </div>
